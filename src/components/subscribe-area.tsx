...
const SubscribeArea = ({ style_2, style_3 }: IProps) => {
  ...
  return (
    <>
      <section className={`subscribe__area pb-100 ${style_2 ? 'grey-bg box-m-15' : ''} ${style_3 ? 'position-relative' : ''}`} style={{ backgroundColor: "", color: "#8D004B"}}>
          ...
          <div className={`subscribe__inner ${style_2 ? 'subscribe__inner-2 pt-120' : 'pt-95'}`}>
            <div className="row">
              <div className="col-xl-8 offset-xl-2 col-lg-8 offset-lg-2">
                <div className="subscribe__content text-center" style={{ backgroundColor: "", color: "#8D004B"}}>
