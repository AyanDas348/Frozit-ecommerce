                ...
                <div className="footer__widget mb-30">
                  ...
                  <div className="footer__widget-content">
                    <p>
                      ...
                      Delectable Bakery products, Refreshing Drinks and much
                      more. You can enjoy all the products served as ready to
                      eat at our outlet or get the packaged frozen ones for
                      later use.
                    </p>
                    <div className="footer__contact">
                      <ul>
                        <li>
                          ...
                          <div className="text">
                            <span>
                              Om Oil & Flour Mills Ltd (Frozen Food Division),
                              Type- 2, No-8, Industrial Estate, Madhupatna,
                              Cuttack - 753010 Odisha, India
                            </span>
                          </div>
                        </li>
                        <li>
